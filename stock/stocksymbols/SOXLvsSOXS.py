...
tqqq_data = yf.download(tqqq_symbol, start='2023-01-14', end='2024-02-01')
sqqq_data = yf.download(sqqq_symbol, start='2023-01-14', end='2024-02-01')
