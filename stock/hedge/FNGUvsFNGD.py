...
tqqq_data = yf.download(tqqq_symbol, start='2022-01-14', end='2023-02-01')
sqqq_data = yf.download(sqqq_symbol, start='2022-01-14', end='2023-02-01')
